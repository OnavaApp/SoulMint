    ...
    <section className="relative overflow-hidden py-20 sm:py-32 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
          ...
          <motion.div 
  className="mt-12 relative w-full lg:col-span-6 flex justify-end"
  initial={{ opacity: 0, scale: 0.8 }}
  animate={{ opacity: 1, scale: 1 }}
  transition={{ duration: 0.5, delay: 0.2 }}
>
  <div className="relative translate-x-20"> {/* nudges image slightly to the right */}
    <img
      src="/Phantomwallet.png"
      alt="Solana token visualization"
      className="w-[800px] max-w-none h-auto"
    />
  </div>
</motion.div>
        </div>
